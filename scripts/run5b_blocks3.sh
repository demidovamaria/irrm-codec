...
python scripts/compare_forward_tokenizers.py \
  ...
  --hidden-dim 192 --num-conv-blocks 3 \
  --seeds 1 \
  --configs char \
  --output-root artifacts/compare_forward_tokenizers_2026-08-01_fine_grid_individual_maxlen_maxtokenlen9_anchored_h192_d3_40epochs
