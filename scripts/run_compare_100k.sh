...
python scripts/compare_forward_tokenizers.py \
  ...
  --configs char \
            ...
            wordpiece:artifacts/tokenizers_1M_integ/wordpiece_vocab_40000/tokenizer.json \
            wordpiece:artifacts/tokenizers_1M_integ/wordpiece_vocab_50000/tokenizer.json \
            wordpiece:artifacts/tokenizers_1M_integ/wordpiece_vocab_100000/tokenizer.json \
  --output-root artifacts/compare_forward_tokenizers_background100k
