...
python scripts/compare_forward_tokenizers.py \
  ...
  --hidden-dim 128 --num-conv-blocks 4 \
  --seeds 1 \
  --configs char \
  --output-root artifacts/compare_forward_tokenizers_2026-08-01_fine_grid_individual_maxlen_maxtokenlen9_anchored_h128_d4_40epochs
